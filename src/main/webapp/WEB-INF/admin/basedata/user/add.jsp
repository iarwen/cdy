...
<table class="table table-bordered table-hover definewidth m10">
    <tr>
        ...
        <td><input type="text" name="userName" value="${user.userName}"/><span style="color:red"><c:if test="${errorMsg!=null}">${errorMsg }</c:if></span></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <input type="radio" name="locked" value="1"  <c:if test="${user.locked==1}">checked</c:if>/> 禁用
           <input type="radio" name="locked" value="0" <c:if test="${user.locked==0||user.locked==null}">checked</c:if>/>启用
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <button type="submit" class="btn btn-primary" type="button">保存</button> &nbsp;&nbsp;<button type="button" class="btn btn-success" name="backid" id="backid">取消</button>
        </td>
    </tr>
</table>
</form>
